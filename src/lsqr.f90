...
! 21 Sep 2007: lsqr_m.f90 implemented.
! 24 Oct 2007: Use real(dp) instead of compiler option -r8.
! 19 Dec 2008: lsqrblas_m module implemented.
!+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++

module lsqr_m

    use lsqr_data_m, only : dp
    use lsqrblas_m, only : dnrm2, dscal
    implicit none
...
contains
    ...
    subroutine Aprod2(m, n, x, y, A)
        ...
        x =  x + matmul(transpose(A), y)
    end subroutine Aprod2


    subroutine LSQR(m, n, A, b, damp, wantse, x, se, atol, btol, conlim, & 
    ...
    !-------------------------------------------------------------------
        ...
        real(dp) :: alfopt, alpha, beta, bnorm, cs, cs1, cs2, ctol, &
